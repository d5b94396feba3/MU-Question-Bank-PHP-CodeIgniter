...
<div class="container">
     ...
     <center><h1 style="color: #8B4513;">Edit Question</h1></center> 
      ...
      <input type="hidden" name="text_hidden" value="<?php echo $editQn->q_id; ?>">
     <!-- <h5><?php //echo $editQn->q_id; ?></h5>
     -->
      ...
      <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" value="<?php echo $editQn->q_title; ?>" name="title" id="title" placeholder="Ex: Data Structure" required>
                                </div>
      </div>
      ...
      <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input type="text" value="<?php echo $editQn->q_code; ?>" class="form-control" name="code" id="code" placeholder="Ex:  CSE 340" required>
                                </div>
      </div>
      ...
      <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input type="text" value="<?php echo $editQn->q_dept; ?>" class="form-control" name="dept" id="dept" placeholder="Ex: CSE" required>
                                </div>
      </div>
    ...
    <div class="form-group">
     ...
     <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input value="<?php echo $editQn->q_year; ?>" type="text" class="form-control" name="year" id="year" placeholder="Ex: 2019" required>
                                </div>
      </div>
      ...
      <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="file" value="<?php echo $editQn->q_file; ?>" class="form-control" name="file" id="file" placeholder="Open File">
                                </div>
      </div>
